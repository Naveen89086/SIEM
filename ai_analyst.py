...
class AIAnalyst:
    ...
    def explain_alert(self, alert):
        ...
        if not kb_entry:
            ...
            return {
                "explanation": alert.get("message", "Standard security event detected. Pattern matching suggests anomalous behavior for this protocol/host."),
                "impact": "Medium - Assessment required to determine intent.",
                "recommendation": "Verify host baseline. Check source IP reputation and related events in the timeline."
            }
